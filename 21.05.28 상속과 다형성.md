...
public class Customer {
	...
	public void showCustomerInfo() {
		System.out.println(customerName + "의 등급은 " + customerGrade + "이고, 총 보너스 포인트는" + bonusPoint + "입니다.");
	}
...
public class ArrayListCustomerTest {
	...
	public static void main(String[] args) {
		...
		Customer customer4 = new VIPCustomer(0004, "김효", 1000, 100);
